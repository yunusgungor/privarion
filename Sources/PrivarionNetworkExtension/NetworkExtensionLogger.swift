// PrivarionNetworkExtension - NetworkExtensionLogger
// File logging infrastructure for network extension components
// Requirements: 4.10, 17.3, 17.5

import Foundation
import Logging

/// File logger for writing network extension events to disk
/// Logs to /var/log/privarion/network-extension.log with fallback to user directory
@available(macOS 10.14, *)
internal class FileLogger {
    private let logFilePath: String
    private let fileManager = FileManager.default
    private let logQueue = DispatchQueue(label: "com.privarion.network-extension.file-logger", qos: .utility)
